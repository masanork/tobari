...
impl MynaMenkyoBackend {
    pub fn new() -> Self {
        ...
        info_data.extend_from_slice(&[0xC5, 0x08]);
        info_data.extend_from_slice(b"20300101");
        info_data.extend_from_slice(&[0xE7, 0x0C]);
        info_data.extend_from_slice(b"123456789012");
