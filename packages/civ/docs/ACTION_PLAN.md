...
- [x] **Comprehensive Mock Card Reader**:
    ...
    - [ ] Implement full **Passport** mock scenarios (BAC/PACE handshake, DG reading).
    - [ ] Implement full **PIV** mock scenarios.
...
- [ ] **Unified Identity Model**:
    - [ ] Design a common trait/struct that maps disparate card data to a standardized JSON schema (e.g., "Full Name", "Birth Date", "Address").
